# Investigating the Bystander Effect in Shared Task Experiments

This repository contains simulation code and analysis exploring the **Bystander Effect in Large Language Models (LLMs)** within structured shared task scenarios.

The project investigates whether LLM behavior changes depending on the number and type of team members and contextual framing, inspired by the classical bystander effect in social psychology.
